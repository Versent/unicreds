...
func Setup(Table *string) (err error) {
	...
	err = waitForTable(Table)

	return
}

// GetSecret retrieve the secret from dynamodb using the name
func GetSecret(Table *string, name string) (*DecryptedCredential, error) {
...
func GetHighestVersion(Table *string, name string) (string, error) {
...
func ListSecrets(Table *string, allVersions bool) ([]*Credential, error) {
...
func GetAllSecrets(Table *string, allVersions bool) ([]*DecryptedCredential, error) {
...
func PutSecret(Table *string, alias, name, secret, version string) error {
...
func DeleteSecret(Table *string, name string) error {
...
func ResolveVersion(Table *string, name string, version int) (string, error) {
	...
	ver, err := GetHighestVersion(Table, name)
	if err != nil {
...
func waitForTable(Table *string) error {
